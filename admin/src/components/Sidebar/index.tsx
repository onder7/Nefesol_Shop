...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="fill-current" width="18" height="18" viewBox="0 0 24 24" fill="none">
        <path d="M12 1C5.93 1 1 5.93 1 12s4.93 11 11 11 11-4.93 11-11S18.07 1 12 1zm.88 16.9v1.6h-1.6v-1.59c-1.7-.31-2.9-1.4-3-2.91h1.6c.1.84.86 1.5 2.2 1.5 1.16 0 1.84-.52 1.84-1.23 0-.62-.42-1-1.78-1.33-1.94-.45-3.4-1.03-3.4-2.7 0-1.39 1.1-2.3 2.54-2.6V6h1.6v1.6c1.5.34 2.4 1.45 2.46 2.66h-1.6c-.06-.78-.6-1.4-1.84-1.4-1.18 0-1.78.55-1.78 1.2 0 .56.38.9 1.78 1.23 1.94.45 3.4 1.07 3.4 2.8 0 1.45-1.1 2.4-2.6 2.71z" fill="currentColor"/>
      </svg>
    ),
  },
  {
