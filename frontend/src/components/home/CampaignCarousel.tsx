        ...
        <div className="relative group">
          ...
          {campaigns.length > 1 && (
            <>
              <button
                onClick={handlePrev}
                className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-6 md:-translate-x-12 p-2 rounded-full bg-white dark:bg-gray-800 shadow-lg text-black dark:text-white hover:scale-110 transition-transform opacity-0 group-hover:opacity-100 z-10"
                aria-label="Önceki"
              >
              ...
              <button
                onClick={handleNext}
                className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-6 md:translate-x-12 p-2 rounded-full bg-white dark:bg-gray-800 shadow-lg text-black dark:text-white hover:scale-110 transition-transform opacity-0 group-hover:opacity-100 z-10"
                aria-label="Sonraki"
              >
