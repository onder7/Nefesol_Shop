  ...
  return (
    <div className="space-y-3">
      {returns.map((r) => {
        ...
        return (
          <div key={r.id} className="rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4">
            ...
            <div className="text-xs text-neutral-500 dark:text-neutral-400 space-y-1">
              <p>Neden: <span className="text-neutral-700 dark:text-neutral-300">{REASON_LABELS[r.reason] ?? r.reason}</span></p>
